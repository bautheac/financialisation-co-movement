...
Table~\ref{tbl-stats-no-regimes} displays descriptive statistics for the
...
\textbf{CHP} is low and vice et versa. In Table~\ref{tbl-stats-regimes}
the mean returns are shown over high (\textbf{contango}) and low
(\textbf{backwardation}) \textbf{CHP} regimes for each time period.\\
...
returns are, as demonstrated in Table~\ref{tbl-stats-regimes}.\\
...
(Table~\ref{tbl-stats-no-regimes}) with eighteen US commodities along
...
(Table~\ref{tbl-stats-regimes}) with fifteen US assets and five of the
GB traded metals showing higher mean returns in \textbf{backwardation}
and the pattern extending to equally weighted portfolios of the two sets
of assets. Volatility is moderately higher for both sets with fifteen US
commodities and three GB metals showing higher figures and interestingly
eminently higher over phases of \textbf{contango}; out of the US complex
only Sugar-\#11 (IFUS) and none of the GB traded metals show higher
volatility figures over \textbf{backwardation} phases. The symmetry
between the dynamics of CHP and \textbf{CHP}'s explanatory power on
individual commodity returns breaks in the crisis period
(Table~\ref{tbl-time-reg-US-CHP}) with both now seemingly converging;
the US cross-sectional average \(R^{2}\) at the individual level
bouncing back up (22.5\% vs 20.8\%) while that at the aggregate level
rises further (14.7\% vs 7.1\%).
...
(Table~\ref{tbl-stats-no-regimes}) with twenty-two US and four UK traded
...
post-crisis period (Table~\ref{tbl-stats-regimes}) with mean returns
higher during phases of \textbf{backwardation} relative to
\textbf{contango}, more so than over the crisis period with seventeen US
commodities showing higher mean returns over \textbf{backwardation}
phases. The difference is significant at the 5\% level for Lumber (XCME)
and at the 10\% level for Palladium (XNYM) while no difference is
significant for the assets showing higher figures over phases of
\textbf{contango}. The pattern is more pronounced for the UK traded
...
and UK traded assets that both show higher mean returns during
\textbf{backwardation} with the difference significant at the 5\% level
for the UK portfolio and the figure close to the 10\% level significance
...
extends to three of the six UK traded metals with the difference
...
portfolios of US and UK traded assets on the other hand both show higher
...
with a stronger increase in the post-crisis period, 27.2\% vs.~22.5\%,
...
in the post-crisis period, 7.5\% vs 14.7\%, with the decrease strongest
...
for each period the figures are shown independently for the entire
period as well as for phases of aggregate backwardation (aggregate CHP
\(\leq\) period median) and aggregate contango (aggregate CHP
\textgreater{} period median). Mean values significant at the 1\%, 5\%
and 10\% level are marked with ***, ** and * respectively. Aggregate CHP
...
\textbf{Corn-\#2 yellow (XCBT)} & \textbf{whole period} & \textbf{sd} & \textcolor[HTML]{4285f4}{\textbf{23\%}} & \textcolor[HTML]{4285f4}{\textbf{29.54\%}} & \textcolor[HTML]{4285f4}{\textbf{36.15\%}} & \textcolor[HTML]{4285f4}{\textbf{21.8\%}}\\
...
\textbf{Oats (XCBT)} & \textbf{whole period} & \textbf{sd} & \textcolor[HTML]{4285f4}{\textbf{32.22\%}} & \textcolor[HTML]{4285f4}{\textbf{31.04\%}} & \textcolor[HTML]{4285f4}{\textbf{34.67\%}} & \textcolor[HTML]{4285f4}{\textbf{29.5\%}}\\
...
\textbf{Soybean meal (XCBT)} & \textbf{whole period} & \textbf{sd} & \textcolor[HTML]{4285f4}{\textbf{26.34\%}} & \textcolor[HTML]{4285f4}{\textbf{32.55\%}} & \textcolor[HTML]{4285f4}{\textbf{31.78\%}} & \textcolor[HTML]{4285f4}{\textbf{25.11\%}}\\
...
\textbf{Soybean oil (XCBT)} & \textbf{whole period} & \textbf{sd} & \textcolor[HTML]{4285f4}{\textbf{21.43\%}} & \textcolor[HTML]{4285f4}{\textbf{28.35\%}} & \textcolor[HTML]{4285f4}{\textbf{25.75\%}} & \textcolor[HTML]{4285f4}{\textbf{18.95\%}}\\
\addlinespace
...
\addlinespace
\textbf{Soybeans (XCBT)} & \textbf{whole period} & \textbf{sd} & \textcolor[HTML]{4285f4}{\textbf{21.47\%}} & \textcolor[HTML]{4285f4}{\textbf{30.04\%}} & \textcolor[HTML]{4285f4}{\textbf{28\%}} & \textcolor[HTML]{4285f4}{\textbf{21.22\%}}\\
...
\textbf{Wheat-SRW (XCBT)} & \textbf{whole period} & \textbf{sd} & \textcolor[HTML]{4285f4}{\textbf{24.93\%}} & \textcolor[HTML]{4285f4}{\textbf{33.03\%}} & \textcolor[HTML]{4285f4}{\textbf{37.62\%}} & \textcolor[HTML]{4285f4}{\textbf{26.58\%}}\\
...
\textbf{Cattle-feeder (XCME)} & \textbf{whole period} & \textbf{sd} & \textcolor[HTML]{4285f4}{\textbf{13.23\%}} & \textcolor[HTML]{4285f4}{\textbf{15.16\%}} & \textcolor[HTML]{4285f4}{\textbf{15.24\%}} & \textcolor[HTML]{4285f4}{\textbf{18.69\%}}\\
...
\textbf{Cattle-live (XCME)} & \textbf{whole period} & \textbf{sd} & \textcolor[HTML]{4285f4}{\textbf{17.1\%}} & \textcolor[HTML]{4285f4}{\textbf{17.43\%}} & \textcolor[HTML]{4285f4}{\textbf{16.32\%}} & \textcolor[HTML]{4285f4}{\textbf{18.3\%}}\\
...
\textbf{Lean hogs (XCME)} & \textbf{whole period} & \textbf{sd} & \textcolor[HTML]{4285f4}{\textbf{38.33\%}} & \textcolor[HTML]{4285f4}{\textbf{31.89\%}} & \textcolor[HTML]{4285f4}{\textbf{30.37\%}} & \textcolor[HTML]{4285f4}{\textbf{36.94\%}}\\
\addlinespace
...
\addlinespace
\textbf{Cocoa (IFUS)} & \textbf{whole period} & \textbf{sd} & \textcolor[HTML]{4285f4}{\textbf{32.66\%}} & \textcolor[HTML]{4285f4}{\textbf{29.99\%}} & \textcolor[HTML]{4285f4}{\textbf{31.03\%}} & \textcolor[HTML]{4285f4}{\textbf{24.69\%}}\\
...
\textbf{Coffee-C (IFUS)} & \textbf{whole period} & \textbf{sd} & \textcolor[HTML]{4285f4}{\textbf{43.84\%}} & \textcolor[HTML]{4285f4}{\textbf{32.3\%}} & \textcolor[HTML]{4285f4}{\textbf{30.17\%}} & \textcolor[HTML]{4285f4}{\textbf{31.86\%}}\\
...
\textbf{Cotton-\#2 (IFUS)} & \textbf{whole period} & \textbf{sd} & \textcolor[HTML]{4285f4}{\textbf{26.38\%}} & \textcolor[HTML]{4285f4}{\textbf{29.01\%}} & \textcolor[HTML]{4285f4}{\textbf{33.26\%}} & \textcolor[HTML]{4285f4}{\textbf{20.61\%}}\\
...
\textbf{Lumber (XCME)} & \textbf{whole period} & \textbf{sd} & \textcolor[HTML]{4285f4}{\textbf{30.58\%}} & \textcolor[HTML]{4285f4}{\textbf{29.39\%}} & \textcolor[HTML]{4285f4}{\textbf{36.31\%}} & \textcolor[HTML]{4285f4}{\textbf{25.1\%}}\\
...
\textbf{Orange juice (IFUS)} & \textbf{whole period} & \textbf{sd} & \textcolor[HTML]{4285f4}{\textbf{29.5\%}} & \textcolor[HTML]{4285f4}{\textbf{33.01\%}} & \textcolor[HTML]{4285f4}{\textbf{34.43\%}} & \textcolor[HTML]{4285f4}{\textbf{29.37\%}}\\
\addlinespace
...
\addlinespace
\textbf{Sugar-\#11 (IFUS)} & \textbf{whole period} & \textbf{sd} & \textcolor[HTML]{4285f4}{\textbf{34.88\%}} & \textcolor[HTML]{4285f4}{\textbf{33.25\%}} & \textcolor[HTML]{4285f4}{\textbf{37.9\%}} & \textcolor[HTML]{4285f4}{\textbf{28.72\%}}\\
...
\textbf{Natural gas (XNYM)} & \textbf{whole period} & \textbf{sd} & \textcolor[HTML]{4285f4}{\textbf{61.55\%}} & \textcolor[HTML]{4285f4}{\textbf{54.6\%}} & \textcolor[HTML]{4285f4}{\textbf{53.58\%}} & \textcolor[HTML]{4285f4}{\textbf{44.58\%}}\\
...
\textbf{Crude oil-WTI (XNYM)} & \textbf{whole period} & \textbf{sd} & \textcolor[HTML]{4285f4}{\textbf{39.87\%}} & \textcolor[HTML]{4285f4}{\textbf{32.56\%}} & \textcolor[HTML]{4285f4}{\textbf{42.84\%}} & \textcolor[HTML]{4285f4}{\textbf{34.69\%}}\\
...
\textbf{Gasoline (XNYM)} & \textbf{whole period} & \textbf{sd} & \textcolor[HTML]{4285f4}{\textbf{42.77\%}} & \textcolor[HTML]{4285f4}{\textbf{41.76\%}} & \textcolor[HTML]{4285f4}{\textbf{40.07\%}} & \textcolor[HTML]{4285f4}{\textbf{37.09\%}}\\
...
\textbf{Heating oil (XNYM)} & \textbf{whole period} & \textbf{sd} & \textcolor[HTML]{4285f4}{\textbf{40.75\%}} & \textcolor[HTML]{4285f4}{\textbf{35.09\%}} & \textcolor[HTML]{4285f4}{\textbf{33.17\%}} & \textcolor[HTML]{4285f4}{\textbf{30.56\%}}\\
\addlinespace
...
\addlinespace
\textbf{Copper (XCEC)} & \textbf{whole period} & \textbf{sd} & \textcolor[HTML]{4285f4}{\textbf{21.23\%}} & \textcolor[HTML]{4285f4}{\textbf{31.89\%}} & \textcolor[HTML]{4285f4}{\textbf{34.91\%}} & \textcolor[HTML]{4285f4}{\textbf{19.56\%}}\\
...
\textbf{Gold (XCEC)} & \textbf{whole period} & \textbf{sd} & \textcolor[HTML]{4285f4}{\textbf{15.14\%}} & \textcolor[HTML]{4285f4}{\textbf{18.89\%}} & \textcolor[HTML]{4285f4}{\textbf{21.46\%}} & \textcolor[HTML]{4285f4}{\textbf{14.41\%}}\\
...
\textbf{Palladium (XNYM)} & \textbf{whole period} & \textbf{sd} & \textcolor[HTML]{4285f4}{\textbf{38.27\%}} & \textcolor[HTML]{4285f4}{\textbf{32.71\%}} & \textcolor[HTML]{4285f4}{\textbf{36.14\%}} & \textcolor[HTML]{4285f4}{\textbf{25.38\%}}\\
...
\textbf{Platinum (XNYM)} & \textbf{whole period} & \textbf{sd} & \textcolor[HTML]{4285f4}{\textbf{22.62\%}} & \textcolor[HTML]{4285f4}{\textbf{22.66\%}} & \textcolor[HTML]{4285f4}{\textbf{25.53\%}} & \textcolor[HTML]{4285f4}{\textbf{19.48\%}}\\
...
\textbf{Silver (XCEC)} & \textbf{whole period} & \textbf{sd} & \textcolor[HTML]{4285f4}{\textbf{22\%}} & \textcolor[HTML]{4285f4}{\textbf{33.92\%}} & \textcolor[HTML]{4285f4}{\textbf{39.87\%}} & \textcolor[HTML]{4285f4}{\textbf{24.35\%}}\\
\addlinespace
...
\addlinespace
\textbf{Aluminium (XLME)} & \textbf{whole period} & \textbf{sd} & \textcolor[HTML]{4285f4}{\textbf{17.6\%}} & \textcolor[HTML]{4285f4}{\textbf{26.41\%}} & \textcolor[HTML]{4285f4}{\textbf{26.48\%}} & \textcolor[HTML]{4285f4}{\textbf{18.56\%}}\\
...
\textbf{Copper (XLME)} & \textbf{whole period} & \textbf{sd} & \textcolor[HTML]{4285f4}{\textbf{19.25\%}} & \textcolor[HTML]{4285f4}{\textbf{31.09\%}} & \textcolor[HTML]{4285f4}{\textbf{34.27\%}} & \textcolor[HTML]{4285f4}{\textbf{18.92\%}}\\
...
\textbf{Lead (XLME)} & \textbf{whole period} & \textbf{sd} & \textcolor[HTML]{4285f4}{\textbf{19.64\%}} & \textcolor[HTML]{4285f4}{\textbf{41.74\%}} & \textcolor[HTML]{4285f4}{\textbf{41.05\%}} & \textcolor[HTML]{4285f4}{\textbf{23.26\%}}\\
...
\textbf{Nickel-primary (XLME)} & \textbf{whole period} & \textbf{sd} & \textcolor[HTML]{4285f4}{\textbf{32.26\%}} & \textcolor[HTML]{4285f4}{\textbf{44.27\%}} & \textcolor[HTML]{4285f4}{\textbf{41.45\%}} & \textcolor[HTML]{4285f4}{\textbf{28.98\%}}\\
...
\textbf{Tin-refined (XLME)} & \textbf{whole period} & \textbf{sd} & \textcolor[HTML]{4285f4}{\textbf{15.38\%}} & \textcolor[HTML]{4285f4}{\textbf{31.71\%}} & \textcolor[HTML]{4285f4}{\textbf{35.61\%}} & \textcolor[HTML]{4285f4}{\textbf{18.79\%}}\\
\addlinespace
...
\addlinespace
\textbf{Zinc (XLME)} & \textbf{whole period} & \textbf{sd} & \textcolor[HTML]{4285f4}{\textbf{21.73\%}} & \textcolor[HTML]{4285f4}{\textbf{38.77\%}} & \textcolor[HTML]{4285f4}{\textbf{36.17\%}} & \textcolor[HTML]{4285f4}{\textbf{23.25\%}}\\
...
\textbf{US commodities} & \textbf{whole period} & \textbf{sd} & \textcolor[HTML]{4285f4}{\textbf{10\%}} & \textcolor[HTML]{4285f4}{\textbf{13.62\%}} & \textcolor[HTML]{4285f4}{\textbf{17.58\%}} & \textcolor[HTML]{4285f4}{\textbf{9.86\%}}\\
...
\textbf{GB commodities} & \textbf{whole period} & \textbf{sd} & \textcolor[HTML]{4285f4}{\textbf{15.66\%}} & \textcolor[HTML]{4285f4}{\textbf{26.91\%}} & \textcolor[HTML]{4285f4}{\textbf{30.24\%}} & \textcolor[HTML]{4285f4}{\textbf{16.19\%}}\\
