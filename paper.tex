...
collection of idiosyncratic markets towards a more congruent ensemble
...
factors that drops below levels observed during financialisation while
the gap between the legs of the long-short factors remains narrower than
...
between regimes with especially pronounced for metal assets globally,
both US and GB traded. These results document the emerging
role/dominance of the \textbf{contango} regime post-crisis and could
provide a valuable basis for further research.
...
(XLME)---show a lower figure with five significant figures---Crude
