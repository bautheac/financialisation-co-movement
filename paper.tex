...
considerations. Using the weekly price, open interest and market
...
results are reported independently for models where the regressor is the
factor itself or one of its legs (results available upon request).
...
across sub-sectors, our \textbf{CHP} construction draws on the full
cross-section of US-traded assets considered in the study.
...
***, ** and * respectively. The results are discussed in
