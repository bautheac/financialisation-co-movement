...
Financialisation was a global phenomenon that, through the channel of
index investment, simultaneously influenced the entire spectrum of
liquid commodities. This sweeping impact spurred the transformation of
...
We set out to address this issue by first examining the average of
weekly pairwise correlations between commodities across the entire
...
over financialisation. These findings indicate higher interdependence
...
period. These findings thus suggest that the US metals sector was the
...
market factor portfolio. We therefore regress the weekly individual
...
of 0.80. In contrast, the corresponding figures for the energy sector
...
term structure factors respectively. Here again the dramatic increase in
pricing performance for the CHP factor is driven by the metals sector,
...
Interestingly, although the factor itself only sees a very modest
...
metals sector, with the average \(R^{2}\) for the group's US traded
assets jumping to 28.2\% during financialisation from 6.2\% over the
past period. The pattern of results for both factors extends to the GB
trade assets and suggest a convergence of Keneysian and Working's term
...
therefore appear to complement the results of Kang et al.~(2020) who
...
// TODO Add correlation results discussion here.
...
30\% (Table~\ref{tbl-regressions-factors}) while that of the CHP factor
decreases and, although increasing, remains modest for the open interest
growth and term structure factors. Taken together, these results
indicate the presence of a systematic factor across the entire
cross-section of the US commodities.
...
\caption{\label{tbl-stats-regimes}This table shows mean returns and
volatility (sd) for the twenty four individual US commodities and the
six GB metals considered in the study as well as for two equally
weighted portfolios formed from the US commodities and the GB metals
respectively across the four periods of interest (past: 1997-2003;
financialisation: 2004-2008; crisis: 2008-2013; post-crisis: 2013-2018).
Figures are shown independently for phases of aggregate backwardation
(aggregate CHP \(\leq\) period median) and aggregate contango (aggregate
CHP \textgreater{} period median). Mean values significant at the 1\%,
5\% and 10\% level are marked with ***, ** and * respectively. Aggregate
