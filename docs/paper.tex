...
Factor model techniques are well suited to isolating common driving factors and detecting co-movement {[}6--13{]} at a broader level, beyond individual pairs of assets, and are commonly used to study commodity market fundamentals {[}14--24{]}; they consequently seem well adapted to study these two issues simultaneously. Building on theory we therefore develop a bespoke commodity-based asset pricing framework comprised of factor models based both on fundamentals as well as liquidity considerations.\\
One of these is based on the Keynes-Hicks {[}4,5,25,26{]} risk transfer approach to the term structure; the corresponding ``theory of normal backwardation'', complemented for the possibility of contango {[}27,28{]}, postulates that futures prices for a given commodity are inversely related to the extent that commercial hedgers are short or long and using commercial hedging pressure (CHP) as a proxy for hedgers net market position we construct factor mimicking portfolios that capture the impact of hedging pressure as a systemic factor {[}29{]}. The cross-sectional nature of financialisation {[}30,31{]} further leads us to extend this paradigm by incorporating aggregate CHP (\textbf{CHP}), a market wide measure of hedging pressure first considered in {[}32{]}. In this context, returns for individual commodities should be high in periods where \textbf{CHP} is low (\textbf{backwardation}) and low in periods where \textbf{CHP} is high (\textbf{contango}). Working's contending approach that relates futures price formation to storage costs in the theory of ``the price of storage'' {[}33{]} forms the basis of another model that we consider where, following {[}20{]} and {[}34{]} who demonstrate that the term structure factor has explanatory power for the cross-section of commodity returns, we construct factor mimicking portfolios using roll-yield as a proxy for the front end shape of individual commodity term structures. We further consider a liquidity-based model following {[}32{]} who find that open interest growth has predictive power for individual commodity returns and again, using the latter measure as a proxy for individual commodity liquidity, we construct long-short factor mimicking portfolios.

\bigskip\bigskip\setlength{\parindent}{0pt}

We study the performance of these models on a set of twenty-four US traded commodities and six UK traded (London Metal Exchange) base metals over the 1997/2018 period that we divide into four distinct sub-periods: pre-financialisation (1997/2003); financialisation (2004/2008\footnote{Starting point based on earlier studies {[}35,36{]}.}); financial crisis and aftermath, including loose monetary policy regimes that followed (2008/2013); and post-crisis (2014-2018).\\
...
This change of paradigm due to the arrival of financial investors, on the other hand, raises the question of whether they functioned as liquidity providers or demanders. Arguments have been put forward in favour of both possibilities with {[}37{]} arguing that financial investors provide liquidity and {[}38{]} taking the opposite stance. Our analysis of individual commodity returns' relation with both CHP and \textbf{CHP} before and during financialisation sheds new lights on this issue with our results suggesting that financial investors may have been liquidity demanders leading hedgers to become liquidity providers.

\medskip\setlength{\parindent}{0pt}

{[}39{]} and {[}40{]} argue that the arrival of financial investors had an impact on the extent of normal backwardation in commodity futures markets. Based on their analysis we would expect our average CHP factor, based on backwardation as measured by hedger's positions (Keynesian perspective, theory of normal backwardation: {[}4{]}, {[}5{]}, {[}41{]}, {[}42{]}), as well our term structure factor, based on backwardation as measured by roll yield (Working's perspective, theory of storage: {[}43{]}, {[}44{]}, {[}45{]}, {[}46{]}, {[}28{]}, {[}47{]}, {[}48{]}, {[}49{]}, {[}50{]}), to be best suited to measure the impact of financialisation.\\
...
The initial view of financialisation was that it consisted of speculative flows which had the effect of driving up and creating bubble like conditions in commodity futures prices\footnote{{[}52{]}; {[}53{]}; {[}54{]}; {[}55{]}; {[}56{]}; {[}57{]}; {[}58{]}; {[}59{]}; {[}2{]}.}. However, the fundamental question of the nature of the impact of financialisation across the entire cross-section of commodity futures markets has not yet been completely answered. We provide an empirical complement to a new stream of theoretical studies that try to model the impact of financialisation on various aspects of commodity futures markets\footnote{{[}60{]}, {[}61{]}, {[}62{]}, {[}63{]}, {[}64{]}, {[}39{]}, {[}65{]}, {[}40{]}.} and demonstrate that the effects of financialisation extend beyond the mechanical effects induced by indexation as outlined in {[}66{]} and {[}31{]}.
...
A world-wide debate ensued about the role of index funds in commodity markets. The first responses to the 2007/2008 crisis of escalating food and energy prices took the form of policy reports, many of which reasoned that the growth of commodity index funds came along with an influx of largely speculative capital that was responsible for driving commodity prices beyond their historic highs {[}54,55,57--59{]}.\\
Early US Senate investigations on the matter drew on pricing and trading data supplied by the CFTC as well as interviews with numerous experts including hedge fund manager Michael Masters who linked the growing presence of index investors in US agricultural and energy markets to the observed surges in both futures and cash prices {[}52,53{]}. This contention has since come to be known as the Masters' hypothesis and was largely endorsed by the final US Senate report on the issue {[}67{]}.\\
At this stage, the question thrust on the academic sphere was whether ``excessive speculation'' (understood as the market activity peculiar to index type investors) was linked to escalating energy and agricultural commodity prices. A number of ensuing academic studies, most of which used commodity specific correlation and causality based analysis have since disproved this contention: {[}68{]}, {[}69{]}, {[}70{]}, {[}71{]}, {[}72{]}, {[}73{]}, {[}74{]} and {[}75{]} investigated the issue in the context of the agricultural markets; meanwhile, {[}76{]}, {[}77{]}, {[}78{]}, {[}79{]}, {[}80{]} and {[}81{]} examined the energy markets while {[}82{]}, {[}83{]} and {[}84{]} studied both energy and agricultural markets and {[}85{]}, {[}86{]} as well as {[}87{]} examined the commodity markets in general. Other studies have underlined various alterations in commodity pricing dynamics over the period. {[}88{]} reject the view that financialisation has not had any effects in the grains markets and demonstrate that trades originated by financial market participants, and specifically index investors, can move prices but tend to be typically volatility-reducing. {[}89{]} contend that the oil price increase between 2004 and 2008 was mainly driven by the strength of global demand but that the financialisation process of commodity markets also played a role. Likewise, {[}90{]} show that non-information-based financial investments have important impacts on commodity prices. {[}30{]}, on the other hand, show that in the case of index commodities, financialisation has transformed the risk sharing, and information discovery functions of commodity futures markets.

\hypertarget{co-movement-data}{%
\subsection{Data}\label{co-movement-data}}

Commodity index swaps, commodity index funds (CIFs), commodity-based exchange traded funds (ETFs) and notes (ETNs) or commodity linked notes (CLNs) were amongst the main investment vehicles that allowed institutional and retail investors to build up commodity exposure in the early 2000s {[}54,59,85,90,91{]}. Most of these products were primarily designed to track prominent commodity indexes among which the S\&P-GSCI, the most popular.\\
...
Taken together these results emphasise the global nature of the impact of financialisation on the metals complex and provide further evidence that global metals co-movement could be detected by US based factor models that combine the Keynesian and Working's term structure paradigms. There seems thus to be information in the factor constructed from hedging pressure based on the Keynesian paradigm relevant to the term structure factor built on the Working paradigm and these findings therefore appear to complement the results of {[}38{]} who find that hedging pressure both conveys information about liquidity provision in the short term (Working paradigm) and risk transfer in the longer term (Keynesian paradigm).
...
Taken together the patterns of results over the crisis and post-crisis periods echo those in {[}51{]} in suggesting that the exogenous shock delivered by the financial crisis combined with the accommodative monetary policy that ensued seem to have initiated a reversion toward pre-financialisation fundamentals in the commodity futures complex.
...
\CSLLeftMargin{{[}1{]} }
\CSLRightInline{Büyükşahin B, Robe MA. Speculators, commodities and cross-market linkages. Journal of International Money and Finance 2014;42:38--70. doi:\href{https://doi.org/10.1016/j.jimonfin.2013.08.004}{10.1016/j.jimonfin.2013.08.004}.}

\leavevmode\vadjust pre{\hypertarget{ref-singleton_investor_2013}{}}%
\CSLLeftMargin{{[}2{]} }
\CSLRightInline{Singleton KJ. Investor flows and the 2008 boom/bust in oil prices. Management Science 2013;60:300--18. doi:\href{https://doi.org/10.1287/mnsc.2013.1756}{10.1287/mnsc.2013.1756}.}

\leavevmode\vadjust pre{\hypertarget{ref-domanski_financial_2007}{}}%
\CSLLeftMargin{{[}3{]} }
\CSLRightInline{Domanski D, Heath A. \href{https://www.bis.org/publ/qtrpdf/r_qt0703g.pdf}{Financial investors and commodity markets}. Working Paper 2007.}

\leavevmode\vadjust pre{\hypertarget{ref-keynes_treatise_1930}{}}%
\CSLLeftMargin{{[}4{]} }
\CSLRightInline{Keynes JM. Treatise on money. Macmillan, London; 1930.}

\leavevmode\vadjust pre{\hypertarget{ref-hicks_value_1939}{}}%
\CSLLeftMargin{{[}5{]} }
\CSLRightInline{Hicks JR. Value and capital. 1st ed. Oxford University Press, Cambridge; 1939.}

\leavevmode\vadjust pre{\hypertarget{ref-fama_common_1993}{}}%
\CSLLeftMargin{{[}6{]} }
\CSLRightInline{Fama EF, French KR. Common risk factors in the returns on stocks and bonds. Journal of Financial Economics 1993;33:3--56. doi:\href{https://doi.org/10.1016/0304-405X(93)90023-5}{10.1016/0304-405X(93)90023-5}.}

\leavevmode\vadjust pre{\hypertarget{ref-carhart_persistence_1997}{}}%
\CSLLeftMargin{{[}7{]} }
\CSLRightInline{Carhart MM. On persistence in mutual fund performance. The Journal of Finance 1997;52:57--82. doi:\href{https://doi.org/10.2307/2329556}{10.2307/2329556}.}

\leavevmode\vadjust pre{\hypertarget{ref-asness_devil_2013}{}}%
\CSLLeftMargin{{[}8{]} }
\CSLRightInline{Asness C, Frazzini A. The devil in HML{'}s details. The Journal of Portfolio Management 2013;39:49--68. doi:\href{https://doi.org/10.3905/jpm.2013.39.4.049}{10.3905/jpm.2013.39.4.049}.}

\leavevmode\vadjust pre{\hypertarget{ref-fama_five_factor_2015}{}}%
\CSLLeftMargin{{[}9{]} }
\CSLRightInline{Fama EF, French KR. A five-factor asset pricing model. Journal of Financial Economics 2015;116:1--22. doi:\href{https://doi.org/10.1016/j.jfineco.2014.10.010}{10.1016/j.jfineco.2014.10.010}.}

\leavevmode\vadjust pre{\hypertarget{ref-hou_digesting_2015}{}}%
\CSLLeftMargin{{[}10{]} }
\CSLRightInline{Hou K, Xue C, Zhang L. Digesting anomalies: An investment approach. The Review of Financial Studies 2015;28:650--705. doi:\href{https://doi.org/10.1093/rfs/hhu068}{10.1093/rfs/hhu068}.}

\leavevmode\vadjust pre{\hypertarget{ref-asness_fact_2015}{}}%
\CSLLeftMargin{{[}11{]} }
\CSLRightInline{Asness C, Frazzini A, Israel R, Moskowitz T. Fact, fiction, and value investing. The Journal of Portfolio Management 2015;42:34--52. doi:\href{https://doi.org/10.3905/jpm.2015.42.1.034}{10.3905/jpm.2015.42.1.034}.}

\leavevmode\vadjust pre{\hypertarget{ref-frazzini_betting_2014}{}}%
\CSLLeftMargin{{[}12{]} }
\CSLRightInline{Frazzini A, Pedersen LH. Betting against beta. Journal of Financial Economics 2014;111:1--25. doi:\href{https://doi.org/10.1016/j.jfineco.2013.10.005}{10.1016/j.jfineco.2013.10.005}.}

\leavevmode\vadjust pre{\hypertarget{ref-asness_quality_2019}{}}%
\CSLLeftMargin{{[}13{]} }
\CSLRightInline{Asness CS, Frazzini A, Pedersen LH. Quality minus junk. Review of Accounting Studies 2019;24:34--112. doi:\href{https://doi.org/10.1007/s11142-018-9470-2}{10.1007/s11142-018-9470-2}.}

\leavevmode\vadjust pre{\hypertarget{ref-schwartz_short_2000}{}}%
\CSLLeftMargin{{[}14{]} }
\CSLRightInline{Schwartz E, Smith JE. \href{https://www.jstor.org/stable/2661607}{Short-term variations and long-term dynamics in commodity prices}. Management Science 2000;46:893--911.}

\leavevmode\vadjust pre{\hypertarget{ref-miffre_momentum_2007}{}}%
\CSLLeftMargin{{[}15{]} }
\CSLRightInline{Miffre J, Rallis G. Momentum strategies in commodity futures markets. Journal of Banking \& Finance 2007;31:1863--86. doi:\href{https://doi.org/10.1016/j.jbankfin.2006.12.005}{10.1016/j.jbankfin.2006.12.005}.}

\leavevmode\vadjust pre{\hypertarget{ref-gorton_fundamentals_2012}{}}%
\CSLLeftMargin{{[}16{]} }
\CSLRightInline{Gorton GB, Hayashi F, Rouwenhorst KG. The fundamentals of commodity futures returns. Review of Finance 2012;17:35--105. doi:\href{https://doi.org/10.1093/rof/rfs019}{10.1093/rof/rfs019}.}

\leavevmode\vadjust pre{\hypertarget{ref-cortazar_commodity_2013}{}}%
\CSLLeftMargin{{[}17{]} }
\CSLRightInline{Cortazar G, Kovacevic I, Schwartz ES. \href{https://ssrn.com/abstract=2287027}{Commodity and asset pricing models: An integration}. National Bureau of Economic Research, Inc; 2013.}

\leavevmode\vadjust pre{\hypertarget{ref-yang_investment_2013}{}}%
\CSLLeftMargin{{[}18{]} }
\CSLRightInline{Yang F. Investment shocks and the commodity basis spread. Journal of Financial Economics 2013;110:164--84. doi:\href{https://doi.org/10.1016/j.jfineco.2013.04.012}{10.1016/j.jfineco.2013.04.012}.}

\leavevmode\vadjust pre{\hypertarget{ref-daskalaki_factors_2014}{}}%
\CSLLeftMargin{{[}19{]} }
\CSLRightInline{Daskalaki C, Kostakis A, Skiadopoulos G. Are there common factors in individual commodity futures returns? Journal of Banking {\&} Finance 2014;40:346--63. doi:\href{https://doi.org/10.1016/j.jbankfin.2013.11.034}{10.1016/j.jbankfin.2013.11.034}.}

\leavevmode\vadjust pre{\hypertarget{ref-szymanowska_anatomy_2014}{}}%
\CSLLeftMargin{{[}20{]} }
\CSLRightInline{Szymanowska M, De Roon F, Nijman T, Van Den Goorbergh R. An anatomy of commodity futures risk premia. The Journal of Finance 2014;69:453--82. doi:\href{https://doi.org/10.1111/jofi.12096}{10.1111/jofi.12096}.}

\leavevmode\vadjust pre{\hypertarget{ref-fernandez_skewness_2018}{}}%
\CSLLeftMargin{{[}21{]} }
\CSLRightInline{Fernandez-Perez A, Frijns B, Fuertes A-M, Miffre J. The skewness of commodity futures returns. Journal of Banking \& Finance 2018;86:143--58. doi:\href{https://doi.org/10.1016/j.jbankfin.2017.06.015}{10.1016/j.jbankfin.2017.06.015}.}

\leavevmode\vadjust pre{\hypertarget{ref-bakshi_understanding_2019}{}}%
\CSLLeftMargin{{[}22{]} }
\CSLRightInline{Bakshi G, Gao X, Rossi AG. Understanding the sources of risk underlying the cross section of commodity returns. Management Science 2019;65:619--41. doi:\href{https://doi.org/10.1287/mnsc.2017.2840}{10.1287/mnsc.2017.2840}.}

\leavevmode\vadjust pre{\hypertarget{ref-boons_basis_2019}{}}%
\CSLLeftMargin{{[}23{]} }
\CSLRightInline{Boons M, Prado MP. Basis-momentum. The Journal of Finance 2019;74:239--79. doi:\href{https://doi.org/10.1111/jofi.12738}{10.1111/jofi.12738}.}

\leavevmode\vadjust pre{\hypertarget{ref-sakkas_factor_2020}{}}%
\CSLLeftMargin{{[}24{]} }
\CSLRightInline{Sakkas A, Tessaromatis N. Factor based commodity investing. Journal of Banking \& Finance 2020;115:105807. doi:\href{https://doi.org/10.1016/j.jbankfin.2020.105807}{10.1016/j.jbankfin.2020.105807}.}

\leavevmode\vadjust pre{\hypertarget{ref-keynes_some_1923}{}}%
\CSLLeftMargin{{[}25{]} }
\CSLRightInline{Keynes JM. Some aspects of commodity markets. Manchester Guardian Commercial: European Reconstruction Series 1923;13:784--6.}

\leavevmode\vadjust pre{\hypertarget{ref-hicks_value_1946}{}}%
\CSLLeftMargin{{[}26{]} }
\CSLRightInline{Hicks JR. Value and capital. 2nd ed. Oxford University Press, Cambridge; 1946.}

\leavevmode\vadjust pre{\hypertarget{ref-houthakker_restatement_1957}{}}%
\CSLLeftMargin{{[}27{]} }
\CSLRightInline{Houthakker H. \href{https://EconPapers.repec.org/RePEc:cwl:cwldpp:44}{Restatement of the theory of normal backwardation}. Cowles Foundation for Research in Economics, Yale University; 1957.}

\leavevmode\vadjust pre{\hypertarget{ref-cootner_returns_1960}{}}%
\CSLLeftMargin{{[}28{]} }
\CSLRightInline{Cootner PH. Returns to speculators: Telser versus keynes. Journal of Political Economy 1960;68:396--404. doi:\href{https://doi.org/10.1086/258347}{10.1086/258347}.}

\leavevmode\vadjust pre{\hypertarget{ref-basu_capturing_2013}{}}%
\CSLLeftMargin{{[}29{]} }
\CSLRightInline{Basu D, Miffre J. Capturing the risk premium of commodity futures: The role of hedging pressure. Journal of Banking \& Finance 2013;37:2652--64. doi:\href{https://doi.org/10.1016/j.jbankfin.2013.02.031}{10.1016/j.jbankfin.2013.02.031}.}

\leavevmode\vadjust pre{\hypertarget{ref-cheng_financialisation_2014}{}}%
\CSLLeftMargin{{[}30{]} }
\CSLRightInline{Cheng I-H, Xiong W. Financialization of commodity markets. Annual Review of Financial Economics 2014;6:419--41. doi:\href{https://doi.org/10.1146/annurev-financial-110613-034432}{10.1146/annurev-financial-110613-034432}.}

\leavevmode\vadjust pre{\hypertarget{ref-basak_model_2016}{}}%
\CSLLeftMargin{{[}31{]} }
\CSLRightInline{Basak S, Pavlova A. A model of financialization of commodities. The Journal of Finance 2016;71:1511--56. doi:\href{https://doi.org/10.1111/jofi.12408}{10.1111/jofi.12408}.}

\leavevmode\vadjust pre{\hypertarget{ref-hong_what_2012}{}}%
\CSLLeftMargin{{[}32{]} }
\CSLRightInline{Hong H, Yogo M. What does futures market interest tell us about the macroeconomy and asset prices? Journal of Financial Economics 2012;105:473--90. doi:\href{https://doi.org/10.1016/j.jfineco.2012.04.005}{10.1016/j.jfineco.2012.04.005}.}

\leavevmode\vadjust pre{\hypertarget{ref-working_theory_1949}{}}%
\CSLLeftMargin{{[}33{]} }
\CSLRightInline{Working H. \href{https://www.jstor.org/stable/1816601}{The theory of price of storage}. The American Economic Review 1949:1254--62.}

\leavevmode\vadjust pre{\hypertarget{ref-fuertes_commodity_2015}{}}%
\CSLLeftMargin{{[}34{]} }
\CSLRightInline{Fuertes A-M, Miffre J, Fernandez-Perez A. Commodity strategies based on momentum, term structure, and idiosyncratic volatility. Journal of Futures Markets 2015;35:274--97. doi:\href{https://doi.org/10.1002/fut.21656}{10.1002/fut.21656}.}

\leavevmode\vadjust pre{\hypertarget{ref-baker_financialisation_2014}{}}%
\CSLLeftMargin{{[}35{]} }
\CSLRightInline{Baker SD. The financialization of storable commodities. Rochester, NY: Social Science Research Network; 2014. doi:\href{https://doi.org/10.2139/ssrn.2348333}{10.2139/ssrn.2348333}.}

\leavevmode\vadjust pre{\hypertarget{ref-christoffersen_factor_2014}{}}%
\CSLLeftMargin{{[}36{]} }
\CSLRightInline{Christoffersen P, Lunde A, Olesen KV. Factor structure in commodity futures return and volatility. Journal of Financial and Quantitative Analysis 2014:1--74. doi:\href{https://doi.org/10.1017/S0022109018000765}{10.1017/S0022109018000765}.}

\leavevmode\vadjust pre{\hypertarget{ref-moskowitz_time_2012}{}}%
\CSLLeftMargin{{[}37{]} }
\CSLRightInline{Moskowitz TJ, Ooi YH, Pedersen LH. Time series momentum. Journal of Financial Economics 2012;104:228--50. doi:\href{https://doi.org/10.1016/j.jfineco.2011.11.003}{10.1016/j.jfineco.2011.11.003}.}

\leavevmode\vadjust pre{\hypertarget{ref-kang_tale_2020}{}}%
\CSLLeftMargin{{[}38{]} }
\CSLRightInline{Kang W, Rouwenhorst KG, Tang K. A tale of two premiums: The role of hedgers and speculators in commodity futures markets. The Journal of Finance 2020;75:377--417. doi:\href{https://doi.org/10.1111/jofi.12845}{10.1111/jofi.12845}.}

\leavevmode\vadjust pre{\hypertarget{ref-goldstein_speculation_2014}{}}%
\CSLLeftMargin{{[}39{]} }
\CSLRightInline{Goldstein I, Li Y, Yang L. Speculation and hedging in segmented markets. The Review of Financial Studies 2014;27:881--922. doi:\href{https://doi.org/10.1093/rfs/hht059}{10.1093/rfs/hht059}.}

\leavevmode\vadjust pre{\hypertarget{ref-goldstein_commodity_2017}{}}%
\CSLLeftMargin{{[}40{]} }
\CSLRightInline{Goldstein I, Yang L. Commodity financialization and information transmission. Rochester, NY: Social Science Research Network; 2017. doi:\href{https://doi.org/10.2139/ssrn.2555996}{10.2139/ssrn.2555996}.}

\leavevmode\vadjust pre{\hypertarget{ref-houthakker_speculators_1957}{}}%
\CSLLeftMargin{{[}41{]} }
\CSLRightInline{Houthakker HS. Can speculators forecast prices? The Review of Economics and Statistics 1957;39:143--51. doi:\href{https://doi.org/10.2307/1928531}{10.2307/1928531}.}

\leavevmode\vadjust pre{\hypertarget{ref-telser_futures_1958}{}}%
\CSLLeftMargin{{[}42{]} }
\CSLRightInline{Telser LG. Futures trading and the storage of cotton and wheat. Journal of Political Economy 1958;66:233--55. doi:\href{https://doi.org/10.1086/258036}{10.1086/258036}.}

\leavevmode\vadjust pre{\hypertarget{ref-working_price_1933}{}}%
\CSLLeftMargin{{[}43{]} }
\CSLRightInline{Working H. Price relations between july and september wheat futures at chicago since 1885. Wheat Studies 1933;9:187. doi:\href{https://doi.org/10.22004/ag.econ.142876}{10.22004/ag.econ.142876}.}

\leavevmode\vadjust pre{\hypertarget{ref-kaldor_speculation_1939}{}}%
\CSLLeftMargin{{[}44{]} }
\CSLRightInline{Kaldor N. {Speculation and economic stability}. The Review of Economic Studies 1939;7:1--27. doi:\href{https://doi.org/10.2307/2967593}{10.2307/2967593}.}

\leavevmode\vadjust pre{\hypertarget{ref-working_theory_1948}{}}%
\CSLLeftMargin{{[}45{]} }
\CSLRightInline{Working H. Theory of the inverse carrying charge in futures markets. Journal of Farm Economics 1948;30:1--28. doi:\href{https://doi.org/10.2307/1232678}{10.2307/1232678}.}

\leavevmode\vadjust pre{\hypertarget{ref-brennan_supply_1958}{}}%
\CSLLeftMargin{{[}46{]} }
\CSLRightInline{Brennan MJ. \href{https://www.jstor.org/stable/1812340}{The supply of storage}. The American Economic Review 1958;48:50--72.}

\leavevmode\vadjust pre{\hypertarget{ref-weymar_supply_1966}{}}%
\CSLLeftMargin{{[}47{]} }
\CSLRightInline{Weymar FH. \href{http://www.jstor.org/stable/1815306}{The supply of storage revisited}. The American Economic Review 1966;56:1226--34.}

\leavevmode\vadjust pre{\hypertarget{ref-danthine_information_1978}{}}%
\CSLLeftMargin{{[}48{]} }
\CSLRightInline{Danthine J-P. Information, futures prices, and stabilizing speculation. Journal of Economic Theory 1978;17:79--98. doi:\href{https://doi.org/10.1016/0022-0531(78)90124-2}{10.1016/0022-0531(78)90124-2}.}

\leavevmode\vadjust pre{\hypertarget{ref-turnovsky_determination_1983}{}}%
\CSLLeftMargin{{[}49{]} }
\CSLRightInline{Turnovsky SJ. The determination of spot and futures prices with storable commodities. Econometrica 1983;51:1363--87. doi:\href{https://doi.org/10.2307/1912279}{10.2307/1912279}.}

\leavevmode\vadjust pre{\hypertarget{ref-schwartz_stochastic_1997}{}}%
\CSLLeftMargin{{[}50{]} }
\CSLRightInline{Schwartz ES. The stochastic behavior of commodity prices: Implications for valuation and hedging. The Journal of Finance 1997;52:923--73. doi:\href{https://doi.org/10.1111/j.1540-6261.1997.tb02721.x}{10.1111/j.1540-6261.1997.tb02721.x}.}

\leavevmode\vadjust pre{\hypertarget{ref-basu_definancialisation}{}}%
\CSLLeftMargin{{[}51{]} }
\CSLRightInline{Basu D, Bauthéac O. Commodity definancialisation. Working Paper 2021.}

\leavevmode\vadjust pre{\hypertarget{ref-masters_testimony_2008}{}}%
\CSLLeftMargin{{[}52{]} }
\CSLRightInline{Masters MW. Testimony before the committee on homeland security and governmental affairs. US Senate 2008;20.}

\leavevmode\vadjust pre{\hypertarget{ref-masters_accidental_2008}{}}%
\CSLLeftMargin{{[}53{]} }
\CSLRightInline{Masters M, White A. The accidental hunt brothers: How institutional investors are driving up food and energy prices. Working Paper 2008.}

\leavevmode\vadjust pre{\hypertarget{ref-unctad_global_2009}{}}%
\CSLLeftMargin{{[}54{]} }
\CSLRightInline{UNCTAD STF on SI, Cooperation E. \href{https://unctad.org/system/files/official-document/gds20091_en.pdf}{The global economic crisis: Systemic failures and multilateral remedies}. UNCTAD, Geneva 2009.}

\leavevmode\vadjust pre{\hypertarget{ref-deschutter_food_2010}{}}%
\CSLLeftMargin{{[}55{]} }
\CSLRightInline{De Schutter O. \href{https://www2.ohchr.org/english/issues/food/docs/briefing_note_02_september_2010_en.pdf}{Food commodities speculation and food price crises: Regulation to reduce the risks of price volatility}. United Nations Special Rapporteur on the Right to Food Briefing Note 2010;2:1--4.}

\leavevmode\vadjust pre{\hypertarget{ref-gilbert_how_2010}{}}%
\CSLLeftMargin{{[}56{]} }
\CSLRightInline{Gilbert CL. How to understand high food prices. Journal of Agricultural Economics 2010;61:398--425. doi:\href{https://doi.org/10.1111/j.1477-9552.2010.00248.x}{10.1111/j.1477-9552.2010.00248.x}.}

\leavevmode\vadjust pre{\hypertarget{ref-gilbert_speculative_2010}{}}%
\CSLLeftMargin{{[}57{]} }
\CSLRightInline{Gilbert CL. \href{https://www.cftc.gov/sites/default/files/idc/groups/public/@swaps/documents/file/plstudy_14_cifrem.pdf}{Speculative influences on commodity futures prices 2006-2008}. UNCTAD, Geneva 2010.}

\leavevmode\vadjust pre{\hypertarget{ref-herman_not_2011}{}}%
\CSLLeftMargin{{[}58{]} }
\CSLRightInline{Herman M-O, Kelly R, Nash R. \href{https://www.ingentaconnect.com/content/oxpp/oppafl/2011/00000011/00000007/art00005}{Not a game, speculation v. Food security: Regulating financial markets to grow a better future}. Oxfam Policy and Practice: Agriculture, Food and Land 2011;11:127--38.}

\leavevmode\vadjust pre{\hypertarget{ref-schumann_hunger_2011}{}}%
\CSLLeftMargin{{[}59{]} }
\CSLRightInline{Schumann H. \href{https://www.foodwatch.org/uploads/media/foodwatchreport_TheHungerMakers_observationsandcallsforaction_ger_03.pdf}{The hunger-makers: How deutsche bank, goldman sachs and other financial institutions are speculating with food at the expense of the poorest}. Foodwatch, Berlin 2011.}

\leavevmode\vadjust pre{\hypertarget{ref-etula_broker-dealer_2013}{}}%
\CSLLeftMargin{{[}60{]} }
\CSLRightInline{Etula E. Broker-dealer risk appetite and commodity returns. Journal of Financial Econometrics 2013;11:486--521. doi:\href{https://doi.org/10.1093/jjfinec/nbs024}{10.1093/jjfinec/nbs024}.}

\leavevmode\vadjust pre{\hypertarget{ref-acharya_limits_2013}{}}%
\CSLLeftMargin{{[}61{]} }
\CSLRightInline{Acharya VV, Lochstoer LA, Ramadorai T. Limits to arbitrage and hedging: Evidence from commodity markets. Journal of Financial Economics 2013;109:441--65. doi:\href{https://doi.org/10.1016/j.jfineco.2013.03.003}{10.1016/j.jfineco.2013.03.003}.}

\leavevmode\vadjust pre{\hypertarget{ref-cheng_convective_2014}{}}%
\CSLLeftMargin{{[}62{]} }
\CSLRightInline{Cheng I-H, Kirilenko A, Xiong W. Convective risk flows in commodity futures markets. Review of Finance 2014;19:1733--81. doi:\href{https://doi.org/10.1093/rof/rfu043}{10.1093/rof/rfu043}.}

\leavevmode\vadjust pre{\hypertarget{ref-leclercq_equilibrium_2014}{}}%
\CSLLeftMargin{{[}63{]} }
\CSLRightInline{Leclercq E, Praz R. Equilibrium commodity trading. Rochester, NY: Social Science Research Network; 2014. doi:\href{https://doi.org/10.2139/ssrn.2464400}{10.2139/ssrn.2464400}.}

\leavevmode\vadjust pre{\hypertarget{ref-sockin_informational_2015}{}}%
\CSLLeftMargin{{[}64{]} }
\CSLRightInline{Sockin M, Xiong W. Informational frictions and commodity markets. The Journal of Finance 2015;70:2063--98. doi:\href{https://doi.org/10.1111/jofi.12261}{10.1111/jofi.12261}.}

\leavevmode\vadjust pre{\hypertarget{ref-ekeland_speculation_2016}{}}%
\CSLLeftMargin{{[}65{]} }
\CSLRightInline{Ekeland I, Lautier D, Villeneuve B. \href{https://hal.archives-ouvertes.fr/hal-01655848}{Speculation in commodity futures markets: A simple equilibrium model} 2016.}

\leavevmode\vadjust pre{\hypertarget{ref-tang_index_2012}{}}%
\CSLLeftMargin{{[}66{]} }
\CSLRightInline{Tang K, Xiong W. Index investment and the financialization of commodities. Financial Analysts Journal 2012;68:54--74. doi:\href{https://doi.org/10.2469/faj.v68.n6.5}{10.2469/faj.v68.n6.5}.}

\leavevmode\vadjust pre{\hypertarget{ref-senate_excessive_2009}{}}%
\CSLLeftMargin{{[}67{]} }
\CSLRightInline{Senate US. \href{https://www.hsgac.senate.gov/imo/media/doc/REPORTExcessiveSpecullationintheWheatMarketwoexhibitschartsJune2409.pdf?attempt=2}{Excessive speculation in the wheat market}. Majority and Minority Staff Report Permanent Subcommittee on Investigations 2009;24:107--8.}

\leavevmode\vadjust pre{\hypertarget{ref-irwin_devil_2009}{}}%
\CSLLeftMargin{{[}68{]} }
\CSLRightInline{Irwin SH, Sanders DR, Merrin RP. Devil or angel? The role of speculation in the recent commodity price boom (and bust). Journal of Agricultural and Applied Economics 2009;41:377--91. doi:\href{https://doi.org/10.1017/S1074070800002856}{10.1017/S1074070800002856}.}

\leavevmode\vadjust pre{\hypertarget{ref-sanders_adequacy_2010}{}}%
\CSLLeftMargin{{[}69{]} }
\CSLRightInline{Sanders DR, Irwin SH, Merrin RP. The adequacy of speculation in agricultural futures markets: Too much of a good thing? Applied Economic Perspectives and Policy 2010;32:77--94. doi:\href{https://doi.org/10.1093/aepp/ppp006}{10.1093/aepp/ppp006}.}

\leavevmode\vadjust pre{\hypertarget{ref-sanders_impact_2011}{}}%
\CSLLeftMargin{{[}70{]} }
\CSLRightInline{Sanders DR, Irwin SH. The impact of index funds in commodity futures markets: A systems approach. The Journal of Alternative Investments 2011;14:40--9. doi:\href{https://doi.org/10.3905/jai.2011.14.1.040}{10.3905/jai.2011.14.1.040}.}

\leavevmode\vadjust pre{\hypertarget{ref-sanders_new_2011}{}}%
\CSLLeftMargin{{[}71{]} }
\CSLRightInline{Sanders DR, Irwin SH. New evidence on the impact of index funds in u.s. Grain futures markets. Canadian Journal of Agricultural Economics/Revue Canadienne d'agroeconomie 2011;59:519--32. doi:\href{https://doi.org/10.1111/j.1744-7976.2011.01226.x}{10.1111/j.1744-7976.2011.01226.x}.}

\leavevmode\vadjust pre{\hypertarget{ref-irwin_commodity_2013}{}}%
\CSLLeftMargin{{[}72{]} }
\CSLRightInline{Irwin SH. Commodity index investment and food prices: Does the "masters hypothesis" explain recent price spikes? Agricultural Economics 2013;44:29--41. doi:\href{https://doi.org/10.1111/agec.12048}{10.1111/agec.12048}.}

\leavevmode\vadjust pre{\hypertarget{ref-brunetti_commodity_2014}{}}%
\CSLLeftMargin{{[}73{]} }
\CSLRightInline{Brunetti C, Reiffen D. Commodity index trading and hedging costs. Journal of Financial Markets 2014;21:153--80. doi:\href{https://doi.org/10.1016/j.finmar.2014.08.001}{10.1016/j.finmar.2014.08.001}.}

\leavevmode\vadjust pre{\hypertarget{ref-hamilton_effects_2015}{}}%
\CSLLeftMargin{{[}74{]} }
\CSLRightInline{Hamilton JD, Wu JC. Effects of index-fund investing on commodity futures prices. International Economic Review 2015;56:187--205. doi:\href{https://doi.org/10.1111/iere.12099}{10.1111/iere.12099}.}

\leavevmode\vadjust pre{\hypertarget{ref-bruno_financialisation_2017}{}}%
\CSLLeftMargin{{[}75{]} }
\CSLRightInline{Bruno VG, Büyükşahin B, Robe MA. The financialization of food? American Journal of Agricultural Economics 2017;99:243--64. doi:\href{https://doi.org/10.1093/ajae/aaw059}{10.1093/ajae/aaw059}.}

\leavevmode\vadjust pre{\hypertarget{ref-buyuksahin_speculators_2011}{}}%
\CSLLeftMargin{{[}76{]} }
\CSLRightInline{Büyükşahin B, Harris JH. \href{https://www.jstor.org/stable/41323326}{Do speculators drive crude oil futures prices?} The Energy Journal 2011:167--202.}

\leavevmode\vadjust pre{\hypertarget{ref-tokic_speculation_2012}{}}%
\CSLLeftMargin{{[}77{]} }
\CSLRightInline{Tokic D. Speculation and the 2008 oil bubble: The DCOT report analysis. Energy Policy 2012;45:541--50. doi:\href{https://doi.org/10.1016/j.enpol.2012.02.069}{10.1016/j.enpol.2012.02.069}.}

\leavevmode\vadjust pre{\hypertarget{ref-fattouh_role_2013}{}}%
\CSLLeftMargin{{[}78{]} }
\CSLRightInline{Fattouh B, Kilian L, Mahadeva L. \href{https://www.jstor.org/stable/41970495}{The role of speculation in oil markets: What have we learnt so far?} The Energy Journal 2013;34:7--33.}

\leavevmode\vadjust pre{\hypertarget{ref-kilian_role_2014}{}}%
\CSLLeftMargin{{[}79{]} }
\CSLRightInline{Kilian L, Murphy DP. The role of inventories and speculative trading in the global market for crude oil. Journal of Applied Econometrics 2014;29:454--78. doi:\href{https://doi.org/10.1002/jae.2322}{10.1002/jae.2322}.}

\leavevmode\vadjust pre{\hypertarget{ref-knittel_simple_2016}{}}%
\CSLLeftMargin{{[}80{]} }
\CSLRightInline{Knittel CR, Pindyck RS. The simple economics of commodity price speculation. American Economic Journal: Macroeconomics 2016;8:85--110. doi:\href{https://doi.org/10.1257/mac.20140033}{10.1257/mac.20140033}.}

\leavevmode\vadjust pre{\hypertarget{ref-manera_modeling_2016}{}}%
\CSLLeftMargin{{[}81{]} }
\CSLRightInline{Manera M, Nicolini M, Vignati I. Modeling futures price volatility in energy markets: Is there a role for financial speculation? Energy Economics 2016;53:220--9. doi:\href{https://doi.org/10.1016/j.eneco.2014.07.001}{10.1016/j.eneco.2014.07.001}.}

\leavevmode\vadjust pre{\hypertarget{ref-bohl_does_2013}{}}%
\CSLLeftMargin{{[}82{]} }
\CSLRightInline{Bohl MT, Stephan PM. Does futures speculation destabilize spot prices? New evidence for commodity markets. Journal of Agricultural and Applied Economics 2013;45:595--616. doi:\href{https://doi.org/10.1017/S1074070800005150}{10.1017/S1074070800005150}.}

\leavevmode\vadjust pre{\hypertarget{ref-kim_does_2015}{}}%
\CSLLeftMargin{{[}83{]} }
\CSLRightInline{Kim A. Does futures speculation destabilize commodity markets? Journal of Futures Markets 2015;35:696--714. doi:\href{https://doi.org/10.1002/fut.21716}{10.1002/fut.21716}.}

\leavevmode\vadjust pre{\hypertarget{ref-boyd_prevalence_2016}{}}%
\CSLLeftMargin{{[}84{]} }
\CSLRightInline{Boyd NE, Büyükşahin B, Haigh MS, Harris JH. The prevalence, sources, and effects of herding. Journal of Futures Markets 2016;36:671--94. doi:\href{https://doi.org/10.1002/fut.21756}{10.1002/fut.21756}.}

\leavevmode\vadjust pre{\hypertarget{ref-irwin_index_2011}{}}%
\CSLLeftMargin{{[}85{]} }
\CSLRightInline{Irwin SH, Sanders DR. Index funds, financialization, and commodity futures markets. Applied Economic Perspectives and Policy 2011;33:1--31. doi:\href{https://doi.org/10.1093/aepp/ppq032}{10.1093/aepp/ppq032}.}

\leavevmode\vadjust pre{\hypertarget{ref-irwin_financialisation_2012}{}}%
\CSLLeftMargin{{[}86{]} }
\CSLRightInline{Irwin SH, Sanders DR. Financialization and structural change in commodity futures markets. Journal of Agricultural and Applied Economics 2012;44:371--96. doi:\href{https://doi.org/10.1017/S1074070800000481}{10.1017/S1074070800000481}.}

\leavevmode\vadjust pre{\hypertarget{ref-stoll_commodity_2011}{}}%
\CSLLeftMargin{{[}87{]} }
\CSLRightInline{Stoll HR, Whaley RE. Commodity index investing: Speculation or diversification? The Journal of Alternative Investments 2011;14:50--60. doi:\href{https://doi.org/10.2139/ssrn.1633908}{10.2139/ssrn.1633908}.}

\leavevmode\vadjust pre{\hypertarget{ref-gilbert_role_2014}{}}%
\CSLLeftMargin{{[}88{]} }
\CSLRightInline{Gilbert CL, Pfuderer S. The role of index trading in price formation in the grains and oilseeds markets. Journal of Agricultural Economics 2014;65:303--22. doi:\href{https://doi.org/10.1111/1477-9552.12068}{10.1111/1477-9552.12068}.}

\leavevmode\vadjust pre{\hypertarget{ref-juvenal_speculation_2015}{}}%
\CSLLeftMargin{{[}89{]} }
\CSLRightInline{Juvenal L, Petrella I. Speculation in the oil market. Journal of Applied Econometrics 2015;30:621--49. doi:\href{https://doi.org/10.1002/jae.2388}{10.1002/jae.2388}.}

\leavevmode\vadjust pre{\hypertarget{ref-henderson_new_2015}{}}%
\CSLLeftMargin{{[}90{]} }
\CSLRightInline{Henderson BJ, Pearson ND, Wang L. New evidence on the financialization of commodity markets. The Review of Financial Studies 2015;28:1285--311. doi:\href{https://doi.org/10.1093/rfs/hhu091}{10.1093/rfs/hhu091}.}

\leavevmode\vadjust pre{\hypertarget{ref-boons_stock_2012}{}}%
\CSLLeftMargin{{[}91{]} }
\CSLRightInline{Boons M, De Roon F, Szymanowska M. The stock market price of commodity risk. AFA 2012 chicago meetings paper, 2012. doi:\href{https://doi.org/10.2139/ssrn.1785728}{10.2139/ssrn.1785728}.}

\leavevmode\vadjust pre{\hypertarget{ref-ederington_who_2002}{}}%
\CSLLeftMargin{{[}92{]} }
\CSLRightInline{Ederington L, Lee JH. Who trades futures and how: Evidence from the heating oil futures market. The Journal of Business 2002;75:353--73. doi:\href{https://doi.org/10.1086/338706}{10.1086/338706}.}

\leavevmode\vadjust pre{\hypertarget{ref-working_hedging_1953}{}}%
\CSLLeftMargin{{[}93{]} }
\CSLRightInline{Working H. Hedging reconsidered. Journal of Farm Economics 1953;35:544--61. doi:\href{https://doi.org/10.2307/1233368}{10.2307/1233368}.}

\leavevmode\vadjust pre{\hypertarget{ref-till_long_2007}{}}%
\CSLLeftMargin{{[}94{]} }
\CSLRightInline{Till H. A long-term perspective on commodity futures returns. Intelligent commodity investing, London: Risk books; 2007.}

\leavevmode\vadjust pre{\hypertarget{ref-brunetti_speculators_2016}{}}%
\CSLLeftMargin{{[}95{]} }
\CSLRightInline{Brunetti C, Büyükşahin B, Harris JH. Speculators, prices, and market volatility. Journal of Financial and Quantitative Analysis 2016;51:1545--74. doi:\href{https://doi.org/10.1017/S0022109016000569}{10.1017/S0022109016000569}.}

\leavevmode\vadjust pre{\hypertarget{ref-stout_why_1998}{}}%
\CSLLeftMargin{{[}96{]} }
\CSLRightInline{Stout LA. Why the law hates speculators: Regulation and private ordering in the market for OTC derivatives. Duke Law Journal 1998;48:701--86. doi:\href{https://doi.org/10.2307/1373070}{10.2307/1373070}.}

\leavevmode\vadjust pre{\hypertarget{ref-grossman_impossibility_1980}{}}%
\CSLLeftMargin{{[}97{]} }
\CSLRightInline{Grossman SJ, Stiglitz JE. On the impossibility of informationally efficient markets. The American Economic Review 1980;70:393--408. doi:\href{https://doi.org/10.7916/D8765R99}{10.7916/D8765R99}.}

\leavevmode\vadjust pre{\hypertarget{ref-kyle_informed_1989}{}}%
\CSLLeftMargin{{[}98{]} }
\CSLRightInline{Kyle AS. Informed speculation with imperfect competition. The Review of Economic Studies 1989;56:317--55. doi:\href{https://doi.org/10.2307/2297551}{10.2307/2297551}.}

\leavevmode\vadjust pre{\hypertarget{ref-stulz_rethink_1996}{}}%
\CSLLeftMargin{{[}99{]} }
\CSLRightInline{Stulz RM. Rethinking risk management. Journal of Applied Corporate Finance 1996;9:8--25. doi:\href{https://doi.org/10.1111/j.1745-6622.1996.tb00295.x}{10.1111/j.1745-6622.1996.tb00295.x}.}

\leavevmode\vadjust pre{\hypertarget{ref-simsek_speculation_2013}{}}%
\CSLLeftMargin{{[}100{]} }
\CSLRightInline{Simsek A. Speculation and risk sharing with new financial assets. The Quarterly Journal of Economics 2013;128:1365--96. doi:\href{https://doi.org/10.1093/qje/qjt007}{10.1093/qje/qjt007}.}

\leavevmode\vadjust pre{\hypertarget{ref-hirshleifer_speculation_1975}{}}%
\CSLLeftMargin{{[}101{]} }
\CSLRightInline{Hirshleifer J. Speculation and equilibrium: Information, risk, and markets. The Quarterly Journal of Economics 1975;89:519--42. doi:\href{https://doi.org/10.2307/1884690}{10.2307/1884690}.}

\leavevmode\vadjust pre{\hypertarget{ref-hirshleifer_reply_1976}{}}%
\CSLLeftMargin{{[}102{]} }
\CSLRightInline{Hirshleifer J. Reply to comments on" speculation and equilibrium: Information, risk, and markets". The Quarterly Journal of Economics 1976:689--96. doi:\href{https://doi.org/10.2307/1885330}{10.2307/1885330}.}

\leavevmode\vadjust pre{\hypertarget{ref-hirshleifer_theory_1977}{}}%
\CSLLeftMargin{{[}103{]} }
\CSLRightInline{Hirshleifer J. The theory of speculation under alternative regimes of markets. The Journal of Finance 1977;32:975--99. doi:\href{https://doi.org/10.2307/2326507}{10.2307/2326507}.}

\leavevmode\vadjust pre{\hypertarget{ref-duffie_challenges_2014}{}}%
\CSLLeftMargin{{[}104{]} }
\CSLRightInline{Duffie D. Challenges to a policy treatment of sSpeculative trading motivated by differences in beliefs. The Journal of Legal Studies 2014;43:S173--82. doi:\href{https://doi.org/10.1086/677836}{10.1086/677836}.}
