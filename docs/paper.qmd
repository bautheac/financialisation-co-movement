...
make_table("regime difference tests", c("asset", "period"), colnames, align, 1L:4L, 5L:6L)
```
...
make_table("regressions - US returns ~ US CHP", c("regressor", "sector"), colnames, align, 1L:7L, 4L:7L)
```
...
make_table("correlations - inner - periods", c("country", "sector", "subsector"), colnames, align, 1L:8L, 5L:8L)
```
...
make_table("correlations - cross - periods", c("portfolios", "regime"), colnames, align, 1L:2L, 3L:6L)
```
...
make_table("correlations - inner - years", c("country", "sector", "subsector"), colnames, align, 1L:14L, 5L:14L) %>%
  landscape()
```
...
make_table(
  "regressions - all returns ~ market index", c("country", "sector", "subsector"), 
  colnames, align, 1L:7L, 4L:7L
  )
```
...
make_table(
  "regressions - all returns ~ factors", c("country", "sector", "subsector", "factor"), 
  colnames, align, 1L:9L, 6L:9L
  ) %>% landscape()
```
...
make_table("assets taxonomy", c("country", "sector", "subsector"), colnames, align, 1L, 2L:4L)
```
