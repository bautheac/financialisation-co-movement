...
make_table("correlations - periods", c("country", "sector", "subsector"), colnames, align, 1L:8L, 5L:8L)
```
...
make_table("correlations - years", c("country", "sector", "subsector"), colnames, align, 1L:14L, 5L:14L) %>%
  landscape()
```
